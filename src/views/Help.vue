<template>
	<div class="Help">
		...
		<p>
			...
			ligger i
			<a href="https://github.com/oslokommune/tp-dataplattform/blob/master/src/views/Help.vue">
		...
		<p>
			...
			<a href="https://github.com/oslokommune/tp-dataplattform/blob/master/src/App.vue">prosjekt-mappe/src/App.vue</a>
		</p>


		<h2>Vue + IDE</h2>
		<p>
			Pro tip for utvikling i Vue med et IDE: pek på
			<span class="bold">/node_modules/@vue/cli-service/webpack.config.js</span> for å fortelle IDE'et hvordan
			Vue gjør webpack config.
		</p>
	</div>
</template>
...
#examplePurple {
	background-color: $purple-visited;
	color: $grey-light;
}
#exampleGreen {
